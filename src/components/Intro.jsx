...
function Intro() {
  return (
    <div className="flex items-center justify-center flex-col text-center pt-20 pb-6 px-4 sm:px-6 md:px-8 lg:px-0">
      ...
      <p className="text-lg max-w-full md:max-w-3xl lg:max-w-4xl font-bold">
